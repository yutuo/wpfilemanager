...
$path_infos = wp_upload_dir();
$basedir = $path_infos['basedir'] . '/';
...
if($_GET['do'] == 'list') {
	...
	$res = move_uploaded_file($_FILES['file_data']['tmp_name'], $basedir.$file.'/'.$_FILES['file_data']['name']);
	exit;
} elseif ($_GET['do'] == 'download') {
	$filename = basename($basedir.$file);
	$finfo = finfo_open(FILEINFO_MIME_TYPE);
	header('Content-Type: ' . finfo_file($finfo, $basedir.$file));
